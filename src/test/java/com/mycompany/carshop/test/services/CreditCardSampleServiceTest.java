...
import static com.mycompany.carshop.test.repository.CreditCardRepositoryTest.ctx;
...
public class CreditCardSampleServiceTest {
    ...
    public void testForCreditApproval() {
        ...
        String status = creditService.processPayment("503615922279", new BigDecimal("2000.00"), expiryDate);
    ...
    public void testForWrongCreditCardNumber() {
        ...
        creditCardRepository.save(creditCard);
        Assert.assertNotNull(creditCard);
        String status = creditService.processPayment("20102012", new BigDecimal("2000.00"), expiryDate);
    ...
    public void testForWrongCreditCardExpiryDate() {
        ...
        String status = creditService.processPayment("919520", new BigDecimal("2000.00"), wrongDate);
